...
const MapContainer = () => {
  useEffect(() => {
    ...
    marker.setMap(map);
    // 인포윈도우에 표출될 내용
    var iwContent = `<div style="width:110px;padding:5px;text-align:center;margin-left:15px;font-weight:bold;font-size:18px;">한마음 교회<br>
        <a href="https://map.kakao.com/link/map/한마음 교회,35.816473,128.643336" style="font-size:18px; color:blue; text-decoration:none" target="_blank">큰 지도 보기</a></div>`,
